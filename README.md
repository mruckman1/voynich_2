...
- **Italian syllabic tachygraphy** is identified as the encoding mechanism, discriminated from 11 alternatives including the Naibbe cipher
...
| Sec 4.2 | Entropy shift discriminator | 19 | `voynich entropy-shift` |
...
| Sec 6.4 | EVA words as syllables | 29 | `voynich signal-bigram` |
...
- Discriminated from 11 alternative encoding mechanisms (220 instantiations)
...
│   └── phases/               # Phase modules (2-53 + reviewer analyses)
├── data/
